...
public interface NuttParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link NuttParser#funct_modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunct_modifier(NuttParser.Funct_modifierContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitClass_def_stat(NuttParser.Class_def_statContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link NuttParser#class_header}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_header(NuttParser.Class_headerContext ctx);
	/**
	 * Visit a parse tree produced by {@link NuttParser#class_def}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_def(NuttParser.Class_defContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link NuttParser#class_member}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_member(NuttParser.Class_memberContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link NuttParser#scope_qualifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScope_qualifier(NuttParser.Scope_qualifierContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExplicit_operator_exp(NuttParser.Explicit_operator_expContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitOp_call_exp(NuttParser.Op_call_expContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link NuttParser#explicit_operator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExplicit_operator(NuttParser.Explicit_operatorContext ctx);
	/**
