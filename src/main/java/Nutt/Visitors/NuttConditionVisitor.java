...
//	{
//		return VisitorsPool.evalVisitor.visitArray_access(ctx).asFunctional().asBoolean();
//	}
//
//	@Override
...
//			return VisitorsPool.compareVisitor.visitInfix_exp(ctx);
...
//		if(atom.number()!=null) valuable=VisitorsPool.evalVisitor.visitNumber(atom.number());
//		if(atom.string()!=null) valuable=VisitorsPool.evalVisitor.visitString(atom.string());
