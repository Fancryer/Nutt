...
fragment
DEFAULT_OP: OP_Assign | ADD | SUB | MUL | DIV | MOD | DOL | LT | GT | AND | OR | CAR | TIL | Question | Exclamation;

Question: '?';
Sharp: '#';
SHEBANG: Sharp Exclamation SingleLineInputCharacter* -> channel(HIDDEN);
SemiColon: ';';
